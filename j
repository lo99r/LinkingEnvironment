...
remote.origin.url=https://github.com/lo99r/LinkingEnvironment.git
remote.origin.fetch=+refs/heads/*:refs/remotes/origin/*
branch.master.remote=origin
branch.master.merge=refs/heads/master
branch.6.0.1.remote=origin
branch.6.0.1.merge=refs/heads/6.0.1
branch.6.0.remote=origin
branch.6.0.merge=refs/heads/6.0
